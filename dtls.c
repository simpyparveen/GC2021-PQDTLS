...
//Adding Tesla to hash
    ...
    dtls_ec_key_to_uint32(sha256hash, 32, hash);//static void dtls_ec_key_to_uint32(const unsigned char *key, size_t key_size, uint32_t *result)
